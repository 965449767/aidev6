...
object ProjectScaffoldState {
    ...
    fun generateScript(): String {
        ...
        return buildString {
            ...
            appendLine("plugins {")
            appendLine("    id(\"com.android.application\") version \"${ScaffoldBaseline.AGP_VERSION}\" apply false")
            appendLine("    id(\"org.jetbrains.kotlin.android\") version \"${ScaffoldBaseline.KOTLIN_VERSION}\" apply false")
            appendLine("}")
            appendLine("EOF")
            appendLine("")
            ...
            appendLine("    compileSdk = ${ScaffoldBaseline.COMPILE_SDK}")
            appendLine("    defaultConfig {")
            appendLine("        applicationId = \"${f.packageName}\"")
            appendLine("        minSdk = ${ScaffoldBaseline.MIN_SDK}")
            appendLine("        targetSdk = ${ScaffoldBaseline.TARGET_SDK}")
            ...
            ScaffoldBaseline.dependencies.forEach { appendLine("    $it") }
            appendLine("}")
            appendLine("EOF")
            appendLine("")
