...
import com.aidev.four.terminal.CompletionEngine
import com.aidev.four.terminal.EmbeddedTermSession
import com.aidev.four.terminal.SessionManager
import com.aidev.four.terminal.TerminalClientImpl
import com.aidev.four.terminal.TerminalCompletion
import com.aidev.four.terminal.VirtualKeyboardManager
...
class EmbeddedTerminalPage {
    ...
    var terminalView: TerminalView? = null
        private set
    var inputProxy: com.aidev.four.TerminalImeProxyEditText? = null
        private set
    ...
    fun init(activity: Activity) {
        ...
        inputProxy = com.aidev.four.TerminalImeProxyEditText(activity).apply {
    ...
    private fun maybeAutoBootstrapUbuntu() = sessionManager.maybeAutoBootstrapUbuntu()
