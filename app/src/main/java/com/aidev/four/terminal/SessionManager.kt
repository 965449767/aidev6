...
import com.aidev.four.NotifyBridgeService
import com.aidev.four.ShizukuBridgeService
...
import com.aidev.four.TerminalShellAssets
import com.aidev.four.TerminalShellAssetPaths
...
class SessionManager(
    ...
    var autoBootstrapDispatched = false
    ...
    private fun createTerminalSession(id: Int): TerminalSession {
        ...
        return TerminalSession("/system/bin/sh", homeDir?.absolutePath ?: "/data/data/com.aidev.four/files/home",
            ...
            .setPositiveButton("确定") { _, _ ->
                ...
                if (name.isNotEmpty()) {
                    ...
                    if (idx >= 0 && idx < _sessions.size) {
                        _sessions[idx] = _sessions[idx].copy(title = name.take(18))
                        persistSessions()
                    }
                }
            }
    ...
    fun maybeAutoBootstrapUbuntu() {
        if (autoBootstrapDispatched) return
        autoBootstrapDispatched = true
        currentTerminalSession?.write("aidev-auto-bootstrap\r")
    }
