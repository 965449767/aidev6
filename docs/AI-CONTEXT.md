...
### 2. project（每项目不同）
- `docs/app-architecture.md` / `opencode-architecture.md` / `android-guidelines.md` / `coding-guidelines.md` / `dev-workflow.md` / `compose-capabilities.md` / `verification.md` / `silent-install.md`。
- `rules/core/PROJECT.md`（模板，待填充为 aidev6 真实信息）。
